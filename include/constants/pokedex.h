...
// NOTE: To reorder the pokedex, update this file.
enum {
    NATIONAL_DEX_NONE,
    // Start of National Dex
    NATIONAL_DEX_SNIVY,
...
#define KANTO_DEX_COUNT     NATIONAL_DEX_DEOXYS
#define JOHTO_DEX_COUNT     NATIONAL_DEX_DEOXYS
...
enum {
    ...
    HOENN_DEX_KRABBY,
    HOENN_DEX_KINGLER,
    HOENN_DEX_ACCURASEED,
    HOENN_DEX_TREECISION,
    HOENN_DEX_CUBONE,
    HOENN_DEX_MAROWAK,
    HOENN_DEX_HITMONLEE,
    HOENN_DEX_HITMONCHAN,
    HOENN_DEX_HITMONCENA,
    HOENN_DEX_CHANSEY,
    HOENN_DEX_ARMAROUGE,
    ...
    HOENN_DEX_PILOSWINE,
    HOENN_DEX_ANCHORAGE,
    HOENN_DEX_QUARTILERY,
    HOENN_DEX_DELIBERD,
    HOENN_DEX_FROSMOTH,
    HOENN_DEX_HOUNDOUR,
    HOENN_DEX_HOUNDOOM,
    HOENN_DEX_PORYHEDRON,
    HOENN_DEX_BERDEER,
    HOENN_DEX_SMEARGLE,
    HOENN_DEX_TYROGUE,
