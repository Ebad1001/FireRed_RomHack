...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(PEASHOOTER),
    SPECIES_TO_HOENN(MUDEATER),
    ...
    SPECIES_TO_HOENN(GRIMBOLT),
    SPECIES_TO_HOENN(ACCURASEED),
    SPECIES_TO_HOENN(TREECISION),
    SPECIES_TO_HOENN(CUBONE),
    SPECIES_TO_HOENN(MAROWAK),
    SPECIES_TO_HOENN(HITMONLEE),
    SPECIES_TO_HOENN(HITMONCHAN),
    SPECIES_TO_HOENN(HITMONCENA),
    ...
    SPECIES_TO_HOENN(SUNBLOOM),
    SPECIES_TO_HOENN(METALLOY),
    SPECIES_TO_HOENN(AZUMETAL),
    SPECIES_TO_HOENN(GALLADE),
    SPECIES_TO_HOENN(POLISPARK),
    SPECIES_TO_HOENN(SHINX),
    SPECIES_TO_HOENN(LUXIO),
    SPECIES_TO_HOENN(LUXRAY),
    SPECIES_TO_HOENN(PANDARA),
    SPECIES_TO_HOENN(RIOLU),
    SPECIES_TO_HOENN(LUCARIO),
    SPECIES_TO_HOENN(GONIX),
    ...
    SPECIES_TO_HOENN(BOOMER),
    SPECIES_TO_HOENN(SNOWSHREW),
    SPECIES_TO_HOENN(SNOWSLASH),
    SPECIES_TO_HOENN(KLEAVOR),
    SPECIES_TO_HOENN(LEVISCOR),
    SPECIES_TO_HOENN(STEELIX),
    SPECIES_TO_HOENN(ELECTOX),
    SPECIES_TO_HOENN(VAMPERE),
    SPECIES_TO_HOENN(CHARCADET),
    SPECIES_TO_HOENN(SCIZOR),
    SPECIES_TO_HOENN(SHUCKLE),
    SPECIES_TO_HOENN(HERACROSS),
    SPECIES_TO_HOENN(SNEEZLE),
    ...
    SPECIES_TO_HOENN(DRACOON),
    SPECIES_TO_HOENN(ANCHORAGE),
    SPECIES_TO_HOENN(QUARTILERY),
    SPECIES_TO_HOENN(DELIBERD),
    ...
    SPECIES_TO_HOENN(HYATI),
    SPECIES_TO_HOENN(FENRIZ),
    SPECIES_TO_HOENN(PORYHEDRON),
    SPECIES_TO_HOENN(BERDEER),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(PEASHOOTER),
    SPECIES_TO_NATIONAL(MUDEATER),
    ...
    SPECIES_TO_NATIONAL(GRIMBOLT),
    SPECIES_TO_NATIONAL(ACCURASEED),
    SPECIES_TO_NATIONAL(TREECISION),
    SPECIES_TO_NATIONAL(CUBONE),
    SPECIES_TO_NATIONAL(MAROWAK),
    SPECIES_TO_NATIONAL(HITMONLEE),
    SPECIES_TO_NATIONAL(HITMONCHAN),
    SPECIES_TO_NATIONAL(HITMONCENA),
    ...
    SPECIES_TO_NATIONAL(SUNBLOOM),
    SPECIES_TO_NATIONAL(METALLOY),
    SPECIES_TO_NATIONAL(AZUMETAL),
    SPECIES_TO_NATIONAL(GALLADE),
    SPECIES_TO_NATIONAL(POLISPARK),
    SPECIES_TO_NATIONAL(SHINX),
    SPECIES_TO_NATIONAL(LUXIO),
    SPECIES_TO_NATIONAL(LUXRAY),
    SPECIES_TO_NATIONAL(PANDARA),
    SPECIES_TO_NATIONAL(RIOLU),
    SPECIES_TO_NATIONAL(LUCARIO),
    SPECIES_TO_NATIONAL(GONIX),
    ...
    SPECIES_TO_NATIONAL(BOOMER),
    SPECIES_TO_NATIONAL(SNOWSHREW),
    SPECIES_TO_NATIONAL(SNOWSLASH),
    SPECIES_TO_NATIONAL(KLEAVOR),
    SPECIES_TO_NATIONAL(LEVISCOR),
    SPECIES_TO_NATIONAL(STEELIX),
    SPECIES_TO_NATIONAL(ELECTOX),
    SPECIES_TO_NATIONAL(VAMPERE),
    SPECIES_TO_NATIONAL(CHARCADET),
    SPECIES_TO_NATIONAL(SCIZOR),
    SPECIES_TO_NATIONAL(SHUCKLE),
    SPECIES_TO_NATIONAL(HERACROSS),
    SPECIES_TO_NATIONAL(SNEEZLE),
    ...
    SPECIES_TO_NATIONAL(DRACOON),
    SPECIES_TO_NATIONAL(ANCHORAGE),
    SPECIES_TO_NATIONAL(QUARTILERY),
    SPECIES_TO_NATIONAL(DELIBERD),
    ...
    SPECIES_TO_NATIONAL(HYATI),
    SPECIES_TO_NATIONAL(FENRIZ),
    SPECIES_TO_NATIONAL(PORYHEDRON),
    SPECIES_TO_NATIONAL(BERDEER),
    ...
    SPECIES_TO_NATIONAL(ULTERGEIST),
    ...
    SPECIES_TO_NATIONAL(SPARKITE),
    SPECIES_TO_NATIONAL(SPOINK),
    SPECIES_TO_NATIONAL(GRUMPIG),
    SPECIES_TO_NATIONAL(SUSPECTO),
    SPECIES_TO_NATIONAL(DEDTECTO),
    ...
    SPECIES_TO_NATIONAL(FORKNIGHT),
    SPECIES_TO_NATIONAL(DUSKULL),
    SPECIES_TO_NATIONAL(DUSCLOPS),
    SPECIES_TO_NATIONAL(CORVIDOC),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(SPARKITE),
    HOENN_TO_NATIONAL(METALLOY),
    HOENN_TO_NATIONAL(AZUMETAL),
    ...
    HOENN_TO_NATIONAL(FORKNIGHT),
    HOENN_TO_NATIONAL(WOBBUFFET),
    HOENN_TO_NATIONAL(PIDOVE),
    HOENN_TO_NATIONAL(UNFEZANT),
    HOENN_TO_NATIONAL(BOOMER),
    HOENN_TO_NATIONAL(HYATI),
    HOENN_TO_NATIONAL(FENRIZ),
    ...
    HOENN_TO_NATIONAL(SNOWBRAWL),
    HOENN_TO_NATIONAL(CHILPANZEE),
    HOENN_TO_NATIONAL(DRACOON),
    HOENN_TO_NATIONAL(CHINCHOU),
    HOENN_TO_NATIONAL(LANTURN),
    HOENN_TO_NATIONAL(RAMPAPE),
    ...
    HOENN_TO_NATIONAL(SNOWSHREW),
    HOENN_TO_NATIONAL(SNOWSLASH),
    HOENN_TO_NATIONAL(KLEAVOR),
    HOENN_TO_NATIONAL(LEVISCOR),
    HOENN_TO_NATIONAL(STEELIX),
    HOENN_TO_NATIONAL(ELECTOX),
    HOENN_TO_NATIONAL(VAMPERE),
    HOENN_TO_NATIONAL(CHARCADET),
    HOENN_TO_NATIONAL(SCIZOR),
    HOENN_TO_NATIONAL(SHUCKLE),
    HOENN_TO_NATIONAL(SNEEZLE),
    ...
    HOENN_TO_NATIONAL(QUARTILERY),
    HOENN_TO_NATIONAL(DELIBERD),
    HOENN_TO_NATIONAL(FROSMOTH),
    HOENN_TO_NATIONAL(HOUNDOUR),
    HOENN_TO_NATIONAL(HOUNDOOM),
    HOENN_TO_NATIONAL(PORYHEDRON),
    HOENN_TO_NATIONAL(BERDEER),
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if(move == MOVE_SMOG /* MOVE_SPEED_STRIKE */)
    {
        attack = attacker->speed;
    }
    ...
    if(move == MOVE_MIND_READER /* MOVE_RIVALRY */ && defender->ability != ABILITY_OBLIVIOUS)
    {
        u32 speciesAttacker = attacker->species;
        u32 personalityAttacker = attacker->personality;
        u32 speciesDefender = defender->species;
        u32 personalityDefender = defender->personality;
        
        u8 genderAttacker = GetGenderFromSpeciesAndPersonality(speciesAttacker, personalityAttacker);
        u8 genderDefender = GetGenderFromSpeciesAndPersonality(speciesDefender, personalityDefender);
        

        if(genderAttacker == genderDefender && genderAttacker != MON_GENDERLESS && genderDefender != MON_GENDERLESS)
        {
            attack *= 2;
        }
    }
    ...
    if (attacker->ability == ABILITY_IMPULSE && attacker->status1)
        spAttack = (150 * spAttack) / 100;
    if (defender->ability == ABILITY_MYSTIC_GUARD && defender->status1)
        defense = (150 * defense) / 100;
    ...
    if (type == TYPE_FIGHTING && attacker->ability == ABILITY_VITAL_SPIRIT && attacker->hp <= (attacker->maxHP / 3))
        gBattleMovePower = (150 * gBattleMovePower) / 100;
    if (type == TYPE_FLYING && attacker->ability == ABILITY_AERILATE && attacker->hp <= (attacker->maxHP / 3))
        gBattleMovePower = (150 * gBattleMovePower) / 100;
