...
static const u8 sMonSpriteAnchorCoords[][5] = {
    ...
    [SPECIES_BETTERFLY      - 1] = {0x12, 0x1b, 0x08, 0x12, 0x2a},
    ...
    [SPECIES_METAMOTH        - 1] = {0x12, 0x19, 0x08, 0x16, 0x27},
    ...
    [SPECIES_PEASHOOTER      - 1] = {0x15, 0x0e, 0x30, 0x0e, 0x1c},
    [SPECIES_MUDEATER      - 1] = {0x1a, 0x1c, 0x10, 0x15, 0x32},
    [SPECIES_CERULEDGE      - 1] = {0x1e, 0x0f, 0x30, 0x1c, 0x1b},
    ...
    [SPECIES_FASTRAX         - 1] = {0x0e, 0x0d, 0x28, 0x0c, 0x1f},
    ...
    [SPECIES_ROCKRUFF            - 1] = {0x1b, 0x24, 0x20, 0x17, 0x35},
    [SPECIES_SKOLL         - 1] = {0x12, 0x0a, 0x30, 0x0e, 0x1a},
    ...
    [SPECIES_GRIMBOLT       - 1] = {0x1c, 0x18, 0x30, 0x1d, 0x2e},
    [SPECIES_ACCURASEED       - 1] = {0x21, 0x17, 0x30, 0x20, 0x24},
    [SPECIES_TREECISION       - 1] = {0x1c, 0x17, 0x28, 0x1b, 0x25},
    ...
    [SPECIES_HITMONCENA       - 1] = {0x14, 0x11, 0x30, 0x14, 0x24},
    ...
    [SPECIES_ARMAROUGE         - 1] = {0x1c, 0x18, 0x30, 0x1d, 0x29},
    ...
    [SPECIES_FRILLISH         - 1] = {0x16, 0x23, 0x20, 0x15, 0x34},
    [SPECIES_JELLICENT         - 1] = {0x16, 0x0f, 0x30, 0x10, 0x18},
    ...
    [SPECIES_BEARTIC            - 1] = {0x1b, 0x0f, 0x30, 0x19, 0x1c},
    ...
    [SPECIES_BRONZONG         - 1] = {0x18, 0x12, 0x30, 0x10, 0x23},
    ...
    [SPECIES_SNIVY       - 1] = {0x1b, 0x17, 0x30, 0x1b, 0x24},
    [SPECIES_SERVINE         - 1] = {0x1d, 0x10, 0x30, 0x20, 0x1d},
    [SPECIES_SERPENTINE        - 1] = {0x05, 0x0d, 0x28, 0x0d, 0x1b},
    [SPECIES_SCORBUNNY       - 1] = {0x11, 0x1b, 0x30, 0x14, 0x27},
    [SPECIES_RABOOT         - 1] = {0x25, 0x18, 0x30, 0x27, 0x26},
    [SPECIES_SUNBURNER      - 1] = {0x09, 0x10, 0x28, 0x10, 0x1c},
    [SPECIES_TOTODILE        - 1] = {0x16, 0x10, 0x30, 0x19, 0x20},
    [SPECIES_CROCONAW        - 1] = {0x16, 0x10, 0x30, 0x18, 0x21},
    [SPECIES_REXOBOXER      - 1] = {0x0e, 0x0a, 0x28, 0x08, 0x1a},
    [SPECIES_BIDOOF         - 1] = {0x1e, 0x0a, 0x30, 0x1d, 0x15},
    [SPECIES_BIBAREL          - 1] = {0x21, 0x0e, 0x30, 0x21, 0x19},
    [SPECIES_HOOTHOOT        - 1] = {0x1d, 0x15, 0x30, 0x1c, 0x24},
    [SPECIES_NOCTOWL         - 1] = {0x19, 0x0e, 0x30, 0x18, 0x1c},
    [SPECIES_KRICKETOT          - 1] = {0x1b, 0x15, 0x30, 0x1c, 0x24},
    [SPECIES_KRICKETUNE          - 1] = {0x18, 0x12, 0x10, 0x1c, 0x21},
    ...
    [SPECIES_ZORUA          - 1] = {0x1c, 0x18, 0x30, 0x1e, 0x26},
    [SPECIES_ZOROARK       - 1] = {0x1f, 0x19, 0x30, 0x1f, 0x24},
    [SPECIES_LARVESTAR          - 1] = {0x21, 0x15, 0x30, 0x1f, 0x20},
    [SPECIES_VOLCARONA         - 1] = {0x1b, 0x10, 0x30, 0x1c, 0x1c},
    [SPECIES_PIDOVE            - 1] = {0x1c, 0x17, 0x30, 0x15, 0x21},
    [SPECIES_UNFEZANT            - 1] = {0x1b, 0x08, 0x30, 0x19, 0x14},
    ...
    [SPECIES_SUNBLOOM       - 1] = {0x1f, 0x13, 0x30, 0x1f, 0x20},
    [SPECIES_METALLOY          - 1] = {0x1d, 0x15, 0x30, 0x1d, 0x22},
    [SPECIES_AZUMETAL       - 1] = {0x1a, 0x12, 0x30, 0x17, 0x1f},
    [SPECIES_GALLADE       - 1] = {0x20, 0x10, 0x30, 0x20, 0x1f},
    [SPECIES_POLISPARK        - 1] = {0x1d, 0x0f, 0x30, 0x1e, 0x20},
    [SPECIES_SHINX          - 1] = {0x23, 0x25, 0x08, 0x25, 0x33},
    [SPECIES_LUXIO        - 1] = {0x1e, 0x18, 0x08, 0x1c, 0x27},
    [SPECIES_LUXRAY        - 1] = {0x1d, 0x21, 0x08, 0x20, 0x2f},
    [SPECIES_PANDARA           - 1] = {0x1e, 0x29, 0x18, 0x1e, 0x35},
    [SPECIES_RIOLU         - 1] = {0x1f, 0x20, 0x08, 0x24, 0x2e},
    [SPECIES_LUCARIO        - 1] = {0x1c, 0x0c, 0x30, 0x1b, 0x19},
    [SPECIES_GONIX           - 1] = {0x1b, 0x28, 0x08, 0x16, 0x35},
    ...
    [SPECIES_SANDILE         - 1] = {0x24, 0x13, 0x30, 0x20, 0x22},
    [SPECIES_KROKOROK        - 1] = {0x1e, 0x13, 0x28, 0x1d, 0x25},
    [SPECIES_KROOKODILE      - 1] = {0x28, 0x21, 0x08, 0x26, 0x2e},
    [SPECIES_UNOWN           - 1] = {0x20, 0x17, 0x08, 0x1f, 0x21},
    [SPECIES_WOBBUFFET       - 1] = {0x1d, 0x09, 0x30, 0x1d, 0x1a},
    [SPECIES_BOOMER       - 1] = {0x0b, 0x0d, 0x28, 0x11, 0x1d},
    [SPECIES_SNOWSHREW          - 1] = {0x1d, 0x12, 0x10, 0x19, 0x25},
    [SPECIES_SNOWSLASH      - 1] = {0x19, 0x17, 0x08, 0x1e, 0x26},
    [SPECIES_KLEAVOR       - 1] = {0x10, 0x1b, 0x30, 0x0c, 0x2d},
    [SPECIES_LEVISCOR          - 1] = {0x1e, 0x13, 0x08, 0x1d, 0x23},
    [SPECIES_STEELIX         - 1] = {0x0c, 0x0d, 0x28, 0x0d, 0x1c},
    [SPECIES_ELECTOX        - 1] = {0x1b, 0x15, 0x30, 0x1a, 0x23},
    [SPECIES_VAMPERE        - 1] = {0x1c, 0x09, 0x30, 0x19, 0x18},
    [SPECIES_CHARCADET        - 1] = {0x1f, 0x26, 0x20, 0x1d, 0x33},
    ...
    [SPECIES_SNEEZLE         - 1] = {0x1c, 0x13, 0x30, 0x1d, 0x24},
    ...
    [SPECIES_DRACOON         - 1] = {0x19, 0x1d, 0x28, 0x19, 0x2b},
    [SPECIES_ANCHORAGE        - 1] = {0x15, 0x1f, 0x28, 0x13, 0x2b},
    [SPECIES_QUARTILERY       - 1] = {0x1c, 0x11, 0x30, 0x1a, 0x20},
    [SPECIES_DELIBERD        - 1] = {0x1d, 0x11, 0x30, 0x1b, 0x1f},
    [SPECIES_FROSMOTH         - 1] = {0x16, 0x1e, 0x28, 0x1f, 0x27},
    ...
    [SPECIES_HYATI          - 1] = {0x1b, 0x11, 0x30, 0x19, 0x24},
    [SPECIES_FENRIZ         - 1] = {0x11, 0x15, 0x30, 0x19, 0x2c},
    [SPECIES_PORYHEDRON        - 1] = {0x18, 0x11, 0x30, 0x11, 0x20},
    [SPECIES_BERDEER        - 1] = {0x15, 0x15, 0x28, 0x17, 0x28},
    [SPECIES_SMEARGLE        - 1] = {0x18, 0x10, 0x30, 0x1b, 0x25},
    [SPECIES_TYROGUE         - 1] = {0x1e, 0x12, 0x30, 0x1f, 0x1f},
    [SPECIES_ANNIHILAPE       - 1] = {0x1a, 0x39, 0x10, 0x1a, 0x2b},
    [SPECIES_MAMOSWINE        - 1] = {0x20, 0x18, 0x30, 0x21, 0x26},
    [SPECIES_ELECTIVIRE          - 1] = {0x1d, 0x14, 0x30, 0x1d, 0x23},
    [SPECIES_MAGMORTAR           - 1] = {0x1c, 0x15, 0x30, 0x1a, 0x24},
    ...
    [SPECIES_SERELOT          - 1] = {0x15, 0x21, 0x08, 0x1a, 0x2b},
    ...
    [SPECIES_ULTERGEIST         - 1] = {0x21, 0x17, 0x30, 0x1f, 0x26},
    [SPECIES_PANSAGE         - 1] = {0x13, 0x1c, 0x30, 0x11, 0x2a},
    [SPECIES_PANSEAR       - 1] = {0x0f, 0x1b, 0x08, 0x0e, 0x28},
    [SPECIES_PANPOUR         - 1] = {0x14, 0x1d, 0x30, 0x11, 0x2c},
    [SPECIES_PANVOLT          - 1] = {0x14, 0x19, 0x08, 0x16, 0x26},
    ...
    [SPECIES_APPLIN          - 1] = {0x1b, 0x17, 0x30, 0x18, 0x28},
    [SPECIES_FLAPPLE         - 1] = {0x20, 0x0d, 0x30, 0x1a, 0x1d},
    [SPECIES_APPLETUN         - 1] = {0x32, 0x11, 0x28, 0x2e, 0x23},
    ...
    [SPECIES_WIMPOD         - 1] = {0x1d, 0x16, 0x30, 0x1c, 0x25},
    [SPECIES_GOLISOPOD      - 1] = {0x1a, 0x21, 0x08, 0x14, 0x30},
    [SPECIES_WAILMER         - 1] = {0x17, 0x17, 0x30, 0x16, 0x28},
    [SPECIES_WAILORD         - 1] = {0x17, 0x03, 0x30, 0x09, 0x13},
    [SPECIES_FROSLASS          - 1] = {0x24, 0x1a, 0x30, 0x22, 0x2a},
    [SPECIES_PROBOPASS        - 1] = {0x1e, 0x12, 0x30, 0x1c, 0x21},
    ...
    [SPECIES_TYRUNT        - 1] = {0x17, 0x12, 0x30, 0x15, 0x1e},
    [SPECIES_TYRANTRUM        - 1] = {0x18, 0x20, 0x28, 0x17, 0x31},
    [SPECIES_RAMPAPE         - 1] = {0x19, 0x0f, 0x30, 0x13, 0x1c},
    [SPECIES_AMAURA        - 1] = {0x1f, 0x14, 0x30, 0x1d, 0x23},
    [SPECIES_AURORUS       - 1] = {0x14, 0x0c, 0x28, 0x18, 0x23},
    ...
    [SPECIES_SPARKITE         - 1] = {0x1b, 0x10, 0x30, 0x18, 0x1f},
    [SPECIES_SPOINK          - 1] = {0x21, 0x14, 0x30, 0x1b, 0x28},
    [SPECIES_GRUMPIG         - 1] = {0x14, 0x10, 0x30, 0x15, 0x20},
    [SPECIES_SUSPECTO          - 1] = {0x1c, 0x16, 0x08, 0x1d, 0x25},
    [SPECIES_DEDTECTO           - 1] = {0x21, 0x16, 0x08, 0x1f, 0x26},
    ...
    [SPECIES_FORKNIGHT          - 1] = {0x1a, 0x15, 0x30, 0x1b, 0x26},
    [SPECIES_DUSKULL         - 1] = {0x10, 0x18, 0x08, 0x14, 0x2e},
    [SPECIES_DUSCLOPS        - 1] = {0x1c, 0x0f, 0x30, 0x1a, 0x28},
    [SPECIES_CORVIDOC         - 1] = {0x1e, 0x11, 0x30, 0x1d, 0x20},
    ...
    [SPECIES_CETODDLE          - 1] = {0x1b, 0x18, 0x30, 0x17, 0x26},
    [SPECIES_CETITAN          - 1] = {0x1f, 0x06, 0x30, 0x15, 0x13},
    ...
    [SPECIES_MELTAN        - 1] = {0x20, 0x1a, 0x30, 0x1e, 0x26},
    [SPECIES_MELMETAL         - 1] = {0x13, 0x1e, 0x28, 0x15, 0x33},
    [SPECIES_SNOWBRAWL        - 1] = {0x0d, 0x1f, 0x28, 0x03, 0x32},
    ...
    [SPECIES_CHILPANZEE       - 1] = {0x0c, 0x1f, 0x30, 0x09, 0x2d},
    ...
    [SPECIES_POCHITA         - 1] = {0x25, 0x15, 0x08, 0x21, 0x25},
    [SPECIES_WILDMUTT        - 1] = {0x20, 0x12, 0x08, 0x1f, 0x20},
    ...
    [SPECIES_CHAOROSS         - 1] = {0x1c, 0x15, 0x08, 0x1e, 0x22},
#if defined(FIRERED)
