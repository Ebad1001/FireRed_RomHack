...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_BETTERFLY]  = gMonIcon_Betterfly,
    ...
    [SPECIES_METAMOTH]    = gMonIcon_Metamoth,
    ...
    [SPECIES_PEASHOOTER]  = gMonIcon_Peashooter,
    [SPECIES_MUDEATER]  = gMonIcon_Mudeater,
    ...
    [SPECIES_FASTRAX]     = gMonIcon_Fastrax,
    ...
    [SPECIES_GRIMBOLT]   = gMonIcon_Grimbolt,
    [SPECIES_ACCURASEED]   = gMonIcon_Accuraseed,
    [SPECIES_TREECISION]   = gMonIcon_Treecision,
    ...
    [SPECIES_HITMONCENA]   = gMonIcon_Hitmoncena,
    ...
    [SPECIES_LARVESTAR]      = gMonIcon_Larvestar,
    ...
    [SPECIES_SUNBLOOM]   = gMonIcon_Sunbloom,
    [SPECIES_METALLOY]      = gMonIcon_Metalloy,
    [SPECIES_AZUMETAL]   = gMonIcon_Azumetal,
    [SPECIES_GALLADE]   = gMonIcon_Gallade,
    [SPECIES_POLISPARK]    = gMonIcon_Polispark,
    [SPECIES_SHINX]      = gMonIcon_Shinx,
    [SPECIES_LUXIO]    = gMonIcon_Luxio,
    [SPECIES_LUXRAY]    = gMonIcon_Luxray,
    [SPECIES_PANDARA]       = gMonIcon_Pandara,
    [SPECIES_RIOLU]     = gMonIcon_Riolu,
    [SPECIES_LUCARIO]    = gMonIcon_Lucario,
    [SPECIES_GONIX]       = gMonIcon_Gonix,
    ...
    [SPECIES_BOOMER]   = gMonIcon_Boomer,
    [SPECIES_SNOWSHREW]      = gMonIcon_Snowshrew,
    [SPECIES_SNOWSLASH]  = gMonIcon_Snowslash,
    [SPECIES_KLEAVOR]   = gMonIcon_Kleavor,
    [SPECIES_LEVISCOR]      = gMonIcon_Leviscor,
    [SPECIES_STEELIX]     = gMonIcon_Steelix,
    [SPECIES_ELECTOX]    = gMonIcon_Electox,
    [SPECIES_VAMPERE]    = gMonIcon_Vampere,
    ...
    [SPECIES_SNEEZLE]     = gMonIcon_Sneezle,
    ...
    [SPECIES_QUARTILERY]   = gMonIcon_Quartilery,
    [SPECIES_DELIBERD]    = gMonIcon_Deliberd,
    ...
    [SPECIES_HYATI]      = gMonIcon_Hyati,
    [SPECIES_FENRIZ]     = gMonIcon_Fenriz,
    [SPECIES_PORYHEDRON]    = gMonIcon_Poyhedron,
    [SPECIES_BERDEER]    = gMonIcon_Berdeer,
    ...
    [SPECIES_SERELOT]      = gMonIcon_Serelot,
    ...
    [SPECIES_RAMPAPE]     = gMonIcon_Rampape,
    ...
    [SPECIES_SPARKITE]     = gMonIcon_Sparkite,
    [SPECIES_SPOINK]      = gMonIcon_Spoink,
    [SPECIES_GRUMPIG]     = gMonIcon_Grumpig,
    [SPECIES_SUSPECTO]      = gMonIcon_Suspecto,
    [SPECIES_DEDTECTO]       = gMonIcon_Dedtecto,
    ...
    [SPECIES_FORKNIGHT]      = gMonIcon_Forknight,
    [SPECIES_DUSKULL]     = gMonIcon_Duskull,
    [SPECIES_DUSCLOPS]    = gMonIcon_Dusclops,
    [SPECIES_CORVIDOC]     = gMonIcon_Corvidoc,
    ...
    [SPECIES_SNOWBRAWL]    = gMonIcon_Snowbrawl,
    ...
    [SPECIES_CHAOROSS]     = gMonIcon_Chaoross,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_VOLTORB]     = 0,
    [SPECIES_GRIMBOLT]   = 0,
    [SPECIES_ACCURASEED]   = 0,
    [SPECIES_TREECISION]   = 1,
    [SPECIES_CUBONE]      = 1,
    [SPECIES_MAROWAK]     = 1,
    [SPECIES_HITMONLEE]   = 2,
    [SPECIES_HITMONCHAN]  = 2,
    [SPECIES_HITMONCENA]   = 0,
    [SPECIES_KOFFING]     = 2,
    [SPECIES_WEEZING]     = 2,
    [SPECIES_RHYHORN]     = 1,
    [SPECIES_RHYDON]      = 1,
