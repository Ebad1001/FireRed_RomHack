...
} sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_PEASHOOTER, .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SHELLDER,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_KRABBY,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_ACCURASEED,  .jumpType = JUMP_TYPE_SLOW },
    ...
    { .species = SPECIES_ZORUA,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ZOROARK,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_LARVESTAR,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_MAREEP,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_SUNBLOOM,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_METALLOY,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_RIOLU,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_WOOPER,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SNOWSHREW,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ELECTOX,   .jumpType = JUMP_TYPE_NORMAL },
    ...
    { .species = SPECIES_HYATI,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_PORYHEDRON,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_TYROGUE,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_MAMOSWINE,   .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ELECTIVIRE,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_MAGMORTAR,      .jumpType = JUMP_TYPE_FAST },
    ...
    { .species = SPECIES_SPIRALOONE,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_PANSAGE,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_PANPOUR,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_LOTAD,      .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_APPLIN,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_RALTS,      .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_KIRLIA,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_WIMPOD,    .jumpType = JUMP_TYPE_SLOW },
    ...
    { .species = SPECIES_SPARKITE,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_FROSLASS,     .jumpType = JUMP_TYPE_NORMAL },
    ...
    { .species = SPECIES_SUSPECTO,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEDTECTO,      .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_POCHITA,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_WILDMUTT,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CORVIDOC,    .jumpType = JUMP_TYPE_SLOW },
    ...
    { .species = SPECIES_FORKNIGHT,     .jumpType = JUMP_TYPE_NORMAL },
