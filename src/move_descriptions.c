...
const u8 gMoveDescription_Gust[] = _("The foe is trapped\nin a gust of wind\nthat rages for\ntwo to five turns.");
...
const u8 gMoveDescription_FuryAttack[] = _("A large scissor is\nused to slash the\nfoe. It has a high\ncritical-hit ratio."); // MOVE_X_SCISSOR
...
const u8 gMoveDescription_Wrap[] = _("A large boulder is\nthrown at the foe.\nIt has a high\ncritical-hit ratio."); // MOVE_STONE_EDGE
...
const u8 gMoveDescription_Supersonic[] = _("Large ice-shards are\nhurled at the foe.\nIt may make the\nfoe flinch."); // MOVE_AVALANCHE
const u8 gMoveDescription_SonicBoom[] = _("The foe is attacked\nwith raging fists.\nIt may also raise\nthe user's Ph.Atk."); // MOVE_RAGE_FIST
...
const u8 gMoveDescription_DrillPeck[] = _("An attack with the\nsharp beak acting\nas a drill. It\nmay raise Ph.Atk.");
...
const u8 gMoveDescription_PoisonPowder[] = _("Toxic dust is\nscattered wildly.\nIt may paralyze\nthe foe.");
...
const u8 gMoveDescription_Meditate[] = _("The user attacks with\na loud buzz that\nprevents sleep for\ntwo to five turns."); // MOVE_BUG_BUZZ
...
const u8 gMoveDescription_Smokescreen[] = _("The foe is stabbed\nwith poison arm.\nIt may also raise\nthe user's Ph.Atk."); // MOVE_POISON_JAB
const u8 gMoveDescription_ConfuseRay[] = _("The foe is exposed\nto a sinister ray\nthat triggers\nconfusion.");
const u8 gMoveDescription_Withdraw[] = _("The user extends its\nshadow and attacks.\nIt is certain to\nstrike first."); // MOVE_SHADOW_SNEAK
const u8 gMoveDescription_DefenseCurl[] = _("The user curls up\nto conceal weak\nspots and raise its\nPh.Def stat.");
const u8 gMoveDescription_Barrier[] = _("An attack move that\nworks especially\nwell on a foe that\nis switching out."); // MOVE_ROCKY_EXIT
...
const u8 gMoveDescription_Clamp[] = _("The user smashes it-\nself into the target.\nIt is certain to\nstrike first."); // MOVE_ACCELEROCK
...
const u8 gMoveDescription_SpikeCannon[] = _("The foe is attacked\nwith gusty wind.\nIt may raise all\nthe user's stats."); // MOVE_OMINOUS_WIND
const u8 gMoveDescription_Constrict[] = _("A seaquake that\nstrikes all POKéMON\nin battle excluding\nthe user."); // MOVE_SEAQUAKE
const u8 gMoveDescription_Amnesia[] = _("Forgets about\nsomething and\nsharply raises\nSp.Def.");
const u8 gMoveDescription_Kinesis[] = _("The user draws powers\nfrom nature to hit.\nIt may lower the\nfoe's Sp.Def."); // MOVE_ENERGY_BALL
const u8 gMoveDescription_SoftBoiled[] = _("Heals the user by\nup to half its full\nHP. It can be used\nto heal an ally.");
const u8 gMoveDescription_HiJumpKick[] = _("A strong jumping\nknee kick. If it\nmisses, the user is\nhurt.");
const u8 gMoveDescription_Glare[] = _("The foe is hit with\na poisonous cut.\nIt has a high\ncritical-hit ratio."); // MOVE_CROSS_POISON
const u8 gMoveDescription_DreamEater[] = _("Absorbs half the\ndamage it inflicted\non a sleeping foe\nto restore HP.");
const u8 gMoveDescription_PoisonGas[] = _("Ice shards thrown at\nblinding speed.\nIt is certain to\nstrike first."); // MOVE_ICE_SHARD
const u8 gMoveDescription_Barrage[] = _("user uses magnetic\npowers against the\ntarget. It can't be\nevaded."); // MOVE_MAGNET_BOMB
const u8 gMoveDescription_LeechLife[] = _("An attack that\nabsorbs half the\ndamage it inflicted\nto restore HP.");
const u8 gMoveDescription_LovelyKiss[] = _("An attack move that\ngains in intensity if\nthe target has hurt\nthe user."); // MOVE_PAYBACK
...
const u8 gMoveDescription_Sharpen[] = _("The user sharpens\nand raises its\nPh.Atk stat.");
const u8 gMoveDescription_Conversion[] = _("Alters the user's\nability depending\non the users IVs."); // HIDDEN_SKILL
...
const u8 gMoveDescription_ScaryFace[] = _("The foe is attacked\nwith a hard and\nstrong fist. It raises\nthe user's Ph.Atk."); // MOVE_POWER_UP_HIT
const u8 gMoveDescription_FaintAttack[] = _("The user draws up\nclose to the foe\ndisarmingly, then\nhits without fail.");
const u8 gMoveDescription_SweetKiss[] = _("A skyquake that\nstrikes all POKéMON\nin battle excluding\nthe user."); // MOVE_SKYQUAKE
...
const u8 gMoveDescription_Foresight[] = _("The users uses its\nshadow to strike.\nIt has a high\ncritical-hit ratio."); // MOVE_SHADOW_CLAW
...
const u8 gMoveDescription_Detect[] = _("A bright beam of\nlight. It may also\nlower the foe's\nSp.Atk stat."); // MOVE_CRYSTAL_BEAM
...
const u8 gMoveDescription_Swagger[] = _("It confuses the\ntarget but also\nraises its Ph.Atk\nsharply.");
const u8 gMoveDescription_MilkDrink[] = _("It has a high\ncritical-hit ratio.\nIt may also make\nthe foe flinch."); // MOVE_AQUA_CUTTER
...
const u8 gMoveDescription_VitalThrow[] = _("An wave of sludge\nstrikes all POKéMON\nin battle excluding\nthe user."); // MOVE_SLUDGE_WAVE
const u8 gMoveDescription_MorningSun[] = _("Restores the user's\nHP. The amount of\nHP regained varies\nwith the weather.");
const u8 gMoveDescription_Synthesis[] = _("The user shoots\nfireballs at the foe.\nIt hits Two to five\ntimes"); // MOVE_FIERY_SHOTS
...
const u8 gMoveDescription_Twister[] = _("Does boosted damage\nif the target is\nFLYING or DIVING.");
...
const u8 gMoveDescription_RockSmash[] = _("An attack that\ncuts target's Ph.Def.\nIt can also smash\ncracked boulders.");
const u8 gMoveDescription_Whirlpool[] = _("The foe is trapped\nin a fast, vicious\nwhirlpool for two\nto five turns.");
const u8 gMoveDescription_BeatUp[] = _("The users uses its\naura to strike\nthe foe. It can't\nbe evaded."); // MOVE_AURA_SPHERE
const u8 gMoveDescription_FakeOut[] = _("An attack that hits\nfirst and causes\nflinching. Usable\nonly on 1st turn.");
const u8 gMoveDescription_Uproar[] = _("The user attacks in\nan uproar that\nprevents sleep for\ntwo to five turns.");
const u8 gMoveDescription_Stockpile[] = _("The foe is made\nto trip and fall. It\ninflicts more damage\non heavier foes."); // MOVE_GRASS_KNOT
const u8 gMoveDescription_SpitUp[] = _("The user throws a\nhot fiery tackle.\nIt also hurts the\nuser a little."); // MOVE_FLARE_BLITZ
const u8 gMoveDescription_Swallow[] = _("The user throws a\nhigh wave tackle.\nIt also hurts the\nuser a little."); // MOVE_WAVE_CRASH
...
const u8 gMoveDescription_Flatter[] = _("It confuses the\ntarget but also\nraises its Sp.Atk\nsharply.");
...
const u8 gMoveDescription_SmellingSalt[] = _("A strong icy bite.\nIt may also lower\nthe foe's\nSp.Atk stat."); // MOVE_FROSTBITE
...
const u8 gMoveDescription_Taunt[] = _("Prevents the target\nfrom using non-\ndamaging moves for\nnext three turns.");
const u8 gMoveDescription_HelpingHand[] = _("The user thrashes\nabout for two to\nthree turns, then\nbecomes confused."); // MOVE_KILLING_SPREE
...
const u8 gMoveDescription_Endeavor[] = _("Reduces the foe's\nHP to equal the\nuser's. Fails otherwise.");
const u8 gMoveDescription_Eruption[] = _("The higher the\nuser's HP, the more\npowerful this\nattack becomes.");
const u8 gMoveDescription_SkillSwap[] = _("The user employs\nits psychic power\nto swap abilities\nwith the foe.");
const u8 gMoveDescription_Imprison[] = _("A wall of light\ncuts damage from\nall direct attacks\nfor three turns."); // MOVE_DUAL_SCREEN
...
const u8 gMoveDescription_Camouflage[] = _("Alters the user's\ntype depending\non the users IVs."); // HIDDEN_TYPE
const u8 gMoveDescription_TailGlow[] = _("The user aggresively\nstrike the foe\ntwice in one\nturn."); // MOVE_DUAL_CHOP
const u8 gMoveDescription_LusterPurge[] = _("The user attacks\nwith an odd power\nthat may make the\nfoe flinch."); // MOVE_DARK_PULSE
const u8 gMoveDescription_MistBall[] = _("The user attacks\nwith an odd power\nthat may make the\nfoe flinch."); // MOVE_DRAGON_PULSE
const u8 gMoveDescription_FeatherDance[] = _("An attack move that\ngains in intensity if\nthe target has hurt\nthe user."); // MOVE_RETURN_FIRE
const u8 gMoveDescription_TeeterDance[] = _("A wobbly dance\nthat confuses all\nthe POKéMON in\nbattle.");
const u8 gMoveDescription_BlazeKick[] = _("A fiery kick with a\nhigh critical-hit\nratio. It may also\nburn the foe.");
const u8 gMoveDescription_MudSport[] = _("An attack that hits\nfrom beneath and\nmay lower target's Ph.Def."); // MOVE_EARTH_POWER
...
const u8 gMoveDescription_Aromatherapy[] = _("User raises\nall of its stats.\nThe user flinches\nif hit beforehand."); // MOVE_FOCUS_BOOST
const u8 gMoveDescription_FakeTears[] = _("A reckless, life-\nrisking tackle that\nalso hurts the user\na little."); // MOVE_HEAD_SMASH
...
const u8 gMoveDescription_GrassWhistle[] = _("The foe is slashed\nwith a sharp drill.\nIt has a high\ncritical-hit ratio."); // MOVE_DRILL_RUN
...
const u8 gMoveDescription_Block[] = _("The foe is attacked\nby a swarm of bugs.\nIt may lower the foe's\nPh.Def."); // MOVE_INFESTATION
const u8 gMoveDescription_Howl[] = _("The user thrashes\nabout for two to\nthree turns, then\nbecomes confused."); // MOVE_PHANTOM_RAID
...
const u8 gMoveDescription_Bounce[] = _("An attack that\ngrows stronger on\neach successive\nhit."); // MOVE_DRIP_DROP
const u8 gMoveDescription_MudShot[] = _("The user attacks by\nhurling mud.\nIt also reduces the\nfoe's SPEED.");
const u8 gMoveDescription_PoisonTail[] = _("An attack with a\nhigh critical-hit\nratio. It may also\npoison the foe.");
const u8 gMoveDescription_Covet[] = _("The foe is slashed\nwith a sharp swipe.\nIt has a high\ncritical-hit ratio."); // MOVE_NIGHT_SLASH
const u8 gMoveDescription_VoltTackle[] = _("The user throws an\nelectrified tackle.\nIt also hurts the\nuser a little.");
const u8 gMoveDescription_MagicalLeaf[] = _("The foe is attacked\nwith strange leaves\nthat cannot be\nevaded.");
const u8 gMoveDescription_WaterSport[] = _("An attack that hits\nfrom above and\nmay lower target's Sp.Def."); // MOVE_AZURE_DRIVE
...
const u8 gMoveDescription_DoomDesire[] = _("An intense attack\nthat also sharply\nreduces the user's\nSp.Atk stat."); // MOVE_DRACO_METEOR
