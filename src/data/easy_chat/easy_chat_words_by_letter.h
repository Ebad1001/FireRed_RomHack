...
static const u16 sEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_EXCUSE,
    EC_WORD_EXCUSE_ME,
    EC_POKEMON(ACCURASEED),
    EC_POKEMON(TREECISION),
    EC_WORD_EXISTS,
    EC_WORD_EXPENSIVE,
    EC_MOVE2(EXPLOSION),
    EC_POKEMON2(EXPLOUD),
...
static const u16 sEasyChatWordsByLetter_L[] = {
    ...
    EC_MOVE2(LEAF_BLADE),
    EC_WORD_LEARN,
    EC_POKEMON(KRICKETUNE),
    EC_POKEMON(KRICKETOT),
    EC_MOVE(LEECH_LIFE),
    EC_MOVE2(LEECH_SEED),
    EC_MOVE2(LEER),
    EC_WORD_LEFT,
...
static const u16 sEasyChatWordsByLetter_M[] = {
    ...
    EC_MOVE(MIND_READER),
    EC_MOVE2(MINIMIZE),
    EC_POKEMON2(DEDTECTO),
    EC_WORD_MINUS,
    EC_MOVE2(MIRROR_COAT),
    EC_MOVE(MIRROR_MOVE),
    EC_POKEMON(KROOKODILE),
    EC_WORD_MISHEARD,
    EC_WORD_MISS,
    EC_MOVE(MIST),
    EC_MOVE2(MIST_BALL),
...
static const u16 sEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TO_WHOM,
    EC_WORD_TODAY,
    EC_POKEMON(LARVESTAR),
    EC_WORD_TOGETHER,
    EC_POKEMON(VOLCARONA),
    EC_WORD_TOMORROW,
    EC_WORD_TOO,
    EC_WORD_TOO_LATE,
    EC_WORD_TOO_STRONG,
