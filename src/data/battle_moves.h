const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_POUND] =
    {
        .effect = EFFECT_ABSORB, // MOVE_DRAIN_PUNCH
        .power = 40,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_COMET_PUNCH] =
    {
        .effect = EFFECT_QUICK_ATTACK, // MOVE_BULLET_PUNCH
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SUPERSONIC] =
    {
        .effect = EFFECT_FLINCH_HIT, // MOVE_AVALANCHE
        .power = 80,
        .type = TYPE_ICE,
        .accuracy = 90,
        .pp = 10,
    ...
    [MOVE_MEDITATE] =
    {
        .effect = EFFECT_UPROAR, // MOVE_BUG_BUZZ
        .power = 55,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_WITHDRAW] =
    {
        .effect = EFFECT_QUICK_ATTACK, // MOVE_SHADOW_SNEAK
        .power = 40,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_BARRIER] =
    {
        .effect = EFFECT_PURSUIT, // MOVE_ROCKY_EXIT
        .power = 50,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_EGG_BOMB] =
    {
        .effect = EFFECT_SCORCH, // MOVE_SCORCH
        .power = 75,
        .type = TYPE_FIRE,
        .accuracy = 95,
        .pp = 10,
    ...
    [MOVE_SMOG] =
    {
        .effect = EFFECT_QUICK_ATTACK, // MOVE_SPEED_STRIKE
        .power = 60,
        .type = TYPE_FLYING,
        .accuracy = 90,
        .pp = 20,
    ...
    [MOVE_CLAMP] =
    {
        .effect = EFFECT_QUICK_ATTACK, // MOVE_ACCELEROCK
        .power = 40,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SPIKE_CANNON] =
    {
        .effect = EFFECT_ALL_STATS_UP_HIT, // MOVE_OMINOUS_WIND
        .power = 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_CONSTRICT] =
    {
        .effect = EFFECT_HIT, // MOVE_SEAQUAKE
        .power = 90,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_POISON_GAS] =
    {
        .effect = EFFECT_QUICK_ATTACK, // MOVE_ICE_SHARD
        .power = 40,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_BARRAGE] =
    {
        .effect = EFFECT_ALWAYS_HIT, // MOVE_MAGNET_BOMB
        .power = 60,
        .type = TYPE_STEEL,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_SWEET_KISS] =
    { 
        .effect = EFFECT_GUST, // MOVE_SKYQUAKE
        .power = 90,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_SYNTHESIS] =
    {
        .effect = EFFECT_MULTI_HIT, // MOVE_FIERY_SHOTS
        .power = 15,
        .type = TYPE_FIRE,
        .accuracy = 90,
        .pp = 20,
    ...
    [MOVE_BEAT_UP] =
    {
        .effect = EFFECT_ALWAYS_HIT, // MOVE_AURA_SPHERE
        .power = 60,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_STOCKPILE] =
    {
        .effect = EFFECT_LOW_KICK, // MOVE_GRASS_KNOT
        .power = 1,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SPIT_UP] =
    {
        .effect = EFFECT_DOUBLE_EDGE, // MOVE_FLARE_BLITZ
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SWALLOW] =
    {
        .effect = EFFECT_DOUBLE_EDGE, // MOVE_WAVE_CRASH
        .power = 120,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_CHARGE] =
    {
        .effect = EFFECT_SPECIAL_ATTACK_UP_2, // MOVE_CHARGE_UP
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
        .pp = 5,
    ...
    [MOVE_HELPING_HAND] =
    {
        .effect = EFFECT_RAMPAGE, // MOVE_KILLING_SPREE
        .power = 90,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_MAGIC_COAT] =
    {
        .effect = EFFECT_MAGIC_COAT, // MOVE_BLACK_MIRROR
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_CAMOUFLAGE] =
    {
        .effect = EFFECT_CAMOUFLAGE, // MOVE_HIDDEN_TYPE
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_TAIL_GLOW] =
    {
        .effect = EFFECT_DOUBLE_HIT, // MOVE_DUAL_CHOP
        .power = 30,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 30,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        .effect = EFFECT_FLINCH_MINIMIZE_HIT, // MOVE_DARK_PULSE
        .power = 65,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_MIST_BALL] =
    {
        .effect = EFFECT_FLINCH_MINIMIZE_HIT, // MOVE_DRAGON_PULSE
        .power = 65,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_MUD_SPORT] =
    {
        .effect = EFFECT_DEFENSE_DOWN_HIT, // MOVE_EARTH_POWER
        .power = 90,
        .type = TYPE_GROUND,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_BLOCK] =
    {
        .effect = EFFECT_DEFENSE_DOWN_HIT, // MOVE_INFESTATION
        .power = 90,
        .type = TYPE_BUG,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_HOWL] =
    {
        .effect = EFFECT_RAMPAGE, // MOVE_PHANTOM_RAID
        .power = 90,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_DOOM_DESIRE] =
    {
        .effect = EFFECT_OVERHEAT, // MOVE_DRACO_METEOR
        .power = 140,
        .type = TYPE_DRAGON,
        .accuracy = 90,
        .pp = 5,
