const struct Decoration gDecorations[] = {
    {
        ...
        DECORCAT_DOLL,
        3000,
        DecorDesc_METALLOY_DOLL,
        DecorGfx_METALLOY_DOLL
    }, {
        DECOR_LARVESTAR_DOLL,
        _("LARVESTAR DOLL"),
        DECORPERM_SPRITE,
        DECORSHAPE_1x1,
        DECORCAT_DOLL,
        3000,
        DecorDesc_LARVESTAR_DOLL,
        DecorGfx_LARVESTAR_DOLL
    }, {
        ...
        DECORCAT_DOLL,
        3000,
        DecorDesc_MAMOSWINE_DOLL,
        DecorGfx_MAMOSWINE_DOLL
    }, {
        DECOR_TREECKO_DOLL,
        _("TREECKO DOLL"),
        DECORPERM_SPRITE,
        ...
        DECORCAT_DOLL,
        3000,
        DecorDesc_FROSLASS_DOLL,
        DecorGfx_FROSLASS_DOLL
    }, {
        DECOR_SWABLU_DOLL,
        _("SWABLU DOLL"),
        DECORPERM_SPRITE,
        ...
        DECORCAT_DOLL,
        3000,
        DecorDesc_CETODDLE_DOLL,
        DecorGfx_CETODDLE_DOLL
    }, {
        DECOR_LOTAD_DOLL,
        _("LOTAD DOLL"),
        DECORPERM_SPRITE,
