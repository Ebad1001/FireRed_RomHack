const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]    = {{EVO_LEVEL, 15, SPECIES_METAMOTH}},
    ...
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_VILEPLUME},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNBLOOM}},
    [SPECIES_PARAS]      = {{EVO_LEVEL, 20, SPECIES_PARASECT}},
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 20, SPECIES_BETTERFLY}},
    ...
    [SPECIES_PRIMEAPE]   = {{EVO_LEVEL, 40, SPECIES_ANNIHILAPE}},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_POLISPARK}},
    ...
    [SPECIES_PEASHOOTER] = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_MUDEATER}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL_ITEM, ITEM_SALAC_BERRY, SPECIES_FASTRAX}},
    [SPECIES_MAGNEMITE]  = {{EVO_LEVEL, 32, SPECIES_MAGNETON}},
    [SPECIES_DODUO]      = {{EVO_LEVEL, 24, SPECIES_DODRIO}},
    [SPECIES_ROCKRUFF]       = {{EVO_LEVEL, 30, SPECIES_SKOLL},
                            {EVO_LEVEL, 30, SPECIES_HYATI},
                            {EVO_LEVEL, 30, SPECIES_FENRIZ}}, // 
    ...
    [SPECIES_WEEZING]    = {{EVO_LEVEL_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_BRONZONG}},
    ...
    [SPECIES_GONIX]      = {{EVO_LEVEL_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_ONIX},
    ...
    [SPECIES_VOLTORB]    = {{EVO_LEVEL, 28, SPECIES_GRIMBOLT}},
    [SPECIES_ACCURASEED]  = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_TREECISION}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_LEVEL_ITEM, ITEM_GANLON_BERRY, SPECIES_HITMONCHAN},
                            ...
                            {EVO_LEVEL_ITEM, ITEM_LANSAT_BERRY, SPECIES_HITMONCENA}},
    ...
    [SPECIES_SERVINE]    = {{EVO_LEVEL, 40, SPECIES_SERPENTINE}},
    [SPECIES_SCORBUNNY]  = {{EVO_LEVEL, 20, SPECIES_RABOOT}},
    [SPECIES_RABOOT]    = {{EVO_LEVEL, 40, SPECIES_SUNBURNER}},
    [SPECIES_TOTODILE]   = {{EVO_LEVEL, 20, SPECIES_CROCONAW}},
    [SPECIES_CROCONAW]   = {{EVO_LEVEL, 40, SPECIES_REXOBOXER}},
    ...
    [SPECIES_ZORUA]     = {{EVO_FRIENDSHIP, 250, SPECIES_ZOROARK}},
    [SPECIES_LARVESTAR]     = {{EVO_FRIENDSHIP, 150, SPECIES_VOLCARONA}},
    [SPECIES_PIDOVE]       = {{EVO_LEVEL, 24, SPECIES_UNFEZANT}},
    [SPECIES_MAREEP]     = {{EVO_LEVEL, 25, SPECIES_FLAAFFY}},
    [SPECIES_FLAAFFY]    = {{EVO_ITEM, ITEM_DRAGON_SCALE, SPECIES_AMPHAROS}},
    [SPECIES_METALLOY]     = {{EVO_LEVEL, 26, SPECIES_AZUMETAL}},
    [SPECIES_SHINX]     = {{EVO_LEVEL, 18, SPECIES_LUXIO}},
    [SPECIES_LUXIO]   = {{EVO_LEVEL, 36, SPECIES_LUXRAY}},
    [SPECIES_RIOLU]    = {{EVO_FRIENDSHIP, 250, SPECIES_LUCARIO}},
    ...
    [SPECIES_SNOWSHREW]     = {{EVO_LEVEL, 26, SPECIES_SNOWSLASH}},
    [SPECIES_ELECTOX]   = {{EVO_LEVEL, 28, SPECIES_VAMPERE}},
    ...
    [SPECIES_LINOONE]    = {{EVO_LEVEL, 32, SPECIES_ULTERGEIST}},
    ...
    [SPECIES_APPLIN]     = {{EVO_LEVEL_MALE, 32, SPECIES_FLAPPLE},
                            {EVO_LEVEL_FEMALE, 32, SPECIES_APPLETUN}},
    ...
    [SPECIES_KIRLIA]     = {{EVO_LEVEL_MALE, 36, SPECIES_GALLADE},
                            {EVO_LEVEL_FEMALE, 36, SPECIES_GARDEVOIR}},
    [SPECIES_WIMPOD]    = {{EVO_LEVEL, 26, SPECIES_GOLISOPOD}},
    ...
    [SPECIES_NOSEPASS]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_FROSLASS},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_PROBOPASS}},
    ...
    [SPECIES_SUSPECTO]     = {{EVO_LEVEL, 1, SPECIES_DEDTECTO}},
    [SPECIES_DEDTECTO]      = {{EVO_LEVEL, 1, SPECIES_SUSPECTO}},
    [SPECIES_POCHITA]    = {{EVO_LEVEL, 30, SPECIES_WILDMUTT}},
    [SPECIES_CETODDLE]     = {{EVO_LEVEL, 30, SPECIES_CETITAN}},
    ...
    [SPECIES_SNOWBRAWL]   = {{EVO_LEVEL, 25, SPECIES_CHILPANZEE}},
    [SPECIES_CHILPANZEE]  = {{EVO_LEVEL, 45, SPECIES_RAMPAPE}},
