...
static const u16 sTMHMMoves[] =
{
    ...
    MOVE_SHADOW_BALL,
    MOVE_BRICK_BREAK,
    MOVE_FURY_ATTACK, // MOVE_X_SCISSOR,
    MOVE_REFLECT,
    MOVE_SHOCK_WAVE,
    MOVE_FLAMETHROWER,
    MOVE_SLUDGE_BOMB,
    MOVE_SANDSTORM,
    MOVE_FIRE_BLAST,
    MOVE_DETECT, // MOVE_CRYSTAL_BEAM,
    MOVE_AERIAL_ACE,
    MOVE_LUSTER_PURGE, // MOVE_DARK_PULSE,
    MOVE_FACADE,
    MOVE_SMELLING_SALT, // MOVE_FROSTBITE,
    MOVE_REST,
    MOVE_MIST_BALL, // MOVE_DRAGON_PULSE,
    MOVE_MEDITATE, // MOVE_BUG_BUZZ,
    MOVE_STEEL_WING,
    MOVE_CONVERSION, // MOVE_HIDDEN_SKILL,
    MOVE_CAMOUFLAGE, // MOVE_HIDDEN_TYPE,
    MOVE_WILL_O_WISP,
    MOVE_CUT,
    MOVE_FLY,
    MOVE_SURF,
