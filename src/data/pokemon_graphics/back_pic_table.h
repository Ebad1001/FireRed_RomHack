const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BETTERFLY, gMonBackPic_Betterfly),
    ...
    SPECIES_SPRITE(METAMOTH, gMonBackPic_Metamoth),
    ...
    SPECIES_SPRITE(PEASHOOTER, gMonBackPic_Peashooter),
    SPECIES_SPRITE(MUDEATER, gMonBackPic_Mudeater),
    ...
    SPECIES_SPRITE(FASTRAX, gMonBackPic_Fastrax),
    ...
    SPECIES_SPRITE(SKOLL, gMonBackPic_Skoll),
    ...
    SPECIES_SPRITE(GRIMBOLT, gMonBackPic_Grimbolt),
    SPECIES_SPRITE(ACCURASEED, gMonBackPic_Accuraseed),
    SPECIES_SPRITE(TREECISION, gMonBackPic_Treecision),
    ...
    SPECIES_SPRITE(HITMONCENA, gMonBackPic_Hitmoncena),
    ...
    SPECIES_SPRITE(LARVESTAR, gMonBackPic_Larvestar),
    ...
    SPECIES_SPRITE(SUNBLOOM, gMonBackPic_Sunbloom),
    SPECIES_SPRITE(METALLOY, gMonBackPic_Metalloy),
    SPECIES_SPRITE(AZUMETAL, gMonBackPic_Azumetal),
    SPECIES_SPRITE(GALLADE, gMonBackPic_Gallade),
    SPECIES_SPRITE(POLISPARK, gMonBackPic_Polispark),
    SPECIES_SPRITE(SHINX, gMonBackPic_Shinx),
    SPECIES_SPRITE(LUXIO, gMonBackPic_Luxio),
    SPECIES_SPRITE(LUXRAY, gMonBackPic_Luxray),
    SPECIES_SPRITE(PANDARA, gMonBackPic_Pandara),
    SPECIES_SPRITE(RIOLU, gMonBackPic_Riolu),
    SPECIES_SPRITE(LUCARIO, gMonBackPic_Lucario),
    SPECIES_SPRITE(GONIX, gMonBackPic_Gonix),
    ...
    SPECIES_SPRITE(BOOMER, gMonBackPic_Boomer),
    SPECIES_SPRITE(SNOWSHREW, gMonBackPic_Snowshrew),
    SPECIES_SPRITE(SNOWSLASH, gMonBackPic_Snowslash),
    SPECIES_SPRITE(KLEAVOR, gMonBackPic_Kleavor),
    SPECIES_SPRITE(LEVISCOR, gMonBackPic_Leviscor),
    SPECIES_SPRITE(STEELIX, gMonBackPic_Steelix),
    SPECIES_SPRITE(ELECTOX, gMonBackPic_Electox),
    SPECIES_SPRITE(VAMPERE, gMonBackPic_Vampere),
    ...
    SPECIES_SPRITE(SNEEZLE, gMonBackPic_Sneezle),
    ...
    SPECIES_SPRITE(QUARTILERY, gMonBackPic_Quartilery),
    SPECIES_SPRITE(DELIBERD, gMonBackPic_Deliberd),
    ...
    SPECIES_SPRITE(HYATI, gMonBackPic_Hyati),
    SPECIES_SPRITE(FENRIZ, gMonBackPic_Fenriz),
    SPECIES_SPRITE(PORYHEDRON, gMonBackPic_Poyhedron),
    SPECIES_SPRITE(BERDEER, gMonBackPic_Berdeer),
    ...
    SPECIES_SPRITE(SERELOT, gMonBackPic_Serelot),
    ...
    SPECIES_SPRITE(ULTERGEIST, gMonBackPic_Ultergeist),
    ...
    SPECIES_SPRITE(PANVOLT, gMonBackPic_Panvolt),
    ...
    SPECIES_SPRITE(RAMPAPE, gMonBackPic_Rampape),
    ...
    SPECIES_SPRITE(SPARKITE, gMonBackPic_Sparkite),
    SPECIES_SPRITE(SPOINK, gMonBackPic_Spoink),
    SPECIES_SPRITE(GRUMPIG, gMonBackPic_Grumpig),
    SPECIES_SPRITE(SUSPECTO, gMonBackPic_Suspecto),
    SPECIES_SPRITE(DEDTECTO, gMonBackPic_Dedtecto),
    ...
    SPECIES_SPRITE(FORKNIGHT, gMonBackPic_Forknight),
    SPECIES_SPRITE(DUSKULL, gMonBackPic_Duskull),
    SPECIES_SPRITE(DUSCLOPS, gMonBackPic_Dusclops),
    SPECIES_SPRITE(CORVIDOC, gMonBackPic_Corvidoc),
    ...
    SPECIES_SPRITE(SNOWBRAWL, gMonBackPic_Snowbrawl),
    ...
    SPECIES_SPRITE(CHILPANZEE, gMonBackPic_Chilpanzee),
    ...
    SPECIES_SPRITE(POCHITA, gMonBackPic_Pochita),
    SPECIES_SPRITE(WILDMUTT, gMonBackPic_Wildmutt),
    ...
    SPECIES_SPRITE(CHAOROSS, gMonBackPic_Chaoross),
