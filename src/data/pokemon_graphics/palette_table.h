const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(SKOLL, gMonPalette_Skoll),
    ...
    SPECIES_PAL(GRIMBOLT, gMonPalette_Grimbolt),
    SPECIES_PAL(ACCURASEED, gMonPalette_Accuraseed),
    SPECIES_PAL(TREECISION, gMonPalette_Treecision),
    ...
    SPECIES_PAL(LARVESTAR, gMonPalette_Larvestar),
    ...
    SPECIES_PAL(SNOWSHREW, gMonPalette_Snowshrew),
    SPECIES_PAL(SNOWSLASH, gMonPalette_Snowslash),
    ...
    SPECIES_PAL(HYATI, gMonPalette_Hyati),
    SPECIES_PAL(FENRIZ, gMonPalette_Fenriz),
    SPECIES_PAL(PORYHEDRON, gMonPalette_Poyhedron),
    ...
    SPECIES_PAL(SERELOT, gMonPalette_Serelot),
    ...
    SPECIES_PAL(ULTERGEIST, gMonPalette_Ultergeist),
    ...
    SPECIES_PAL(CHILPANZEE, gMonPalette_Chilpanzee),
    ...
    SPECIES_PAL(CHAOROSS, gMonPalette_Chaoross),
